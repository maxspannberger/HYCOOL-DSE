...
def default_q400_hycool() -> AircraftConfig:
    ...
    return AircraftConfig(
        ...
        LEMAC               = 15.457,                 # Distance nose tip to LEMAC [m], placeholder for now
        lfn                 = 14.055,                 # Distance nose tip to LE wing root LEMAC
        hh                  = 4,                    # Normal distance from wing plane to tail plane, placeholder for now

        OEW_cg              = 17.003,                # Distance nose tip to OEW CG [m], placeholder for now
